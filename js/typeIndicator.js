...
/* https://github.com/HendrikD/blockly-plugins/wiki/Type-Indicator */
...
Blockly.Css.getStylesBySelector = function(selector){
	var rules = Blockly.Css.styleSheet_.cssRules;
	var styles = [];
